  ...
  return (
    <div className="calculator">
      ...
      <div className="container">
        ...
        <button type="button" onClick={handleClick} className="key sign AC">AC</button>
        <button type="button" onClick={handleClick} className="key sign">+/-</button>
        <button type="button" onClick={handleClick} className="key sign">%</button>
        <button type="button" onClick={handleClick} className="key sign">÷</button>
        ...
        <button type="button" onClick={handleClick} className="key sign">x</button>
